...
<!-- <div class="flex w-full sm:w-[45%] h-14 border border-gray-300 rounded-xl overflow-hidden"> -->
    @props(['class' => ''])
    <div id="captcha-container" class="w-full sm:w-[44%] h-14 object-contain border sm:border-y border-gray-300 rounded-xl sm:rounded-xl">
        {!! captcha_img('math') !!}
    </div>
       <button type="button"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" width="22" height="22" fill="currentColor">

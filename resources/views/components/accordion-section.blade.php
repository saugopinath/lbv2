...
<div class="rounded overflow-hidden">
    ...
    <button @click="toggleSection('{{ $sectionId }}')"
        ...
        <svg x-show="openSection !== '{{ $sectionId }}'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
    ...
    <div x-show="openSection === '{{ $sectionId }}'" x-transition
        class="p-4 bg-green-50 shadow border-l-4 border-{{ $color }} space-x-2">
        {{ $slot }}
    </div>
</div>

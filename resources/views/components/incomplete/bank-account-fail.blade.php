...
<x-form.input id="bank_account_{{ $item->application_id }}" name="bank_account[{{ $item->application_id }}]" label="Bank Account Number"
    required wire:model="formData.bank_account.{{ $item->application_id }}" placeholder="Enter New Account Number"
...
@error("formData.bank_account.$item->application_id")

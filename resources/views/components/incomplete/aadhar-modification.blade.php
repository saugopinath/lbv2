    ...
    <div class="grid gap-6 mb-4 md:grid-cols-2 px-4">
       ...
       <div class="w-1/3">
        ...
        <div class="w-1/3">
            ...
            <livewire:enclosure-list :application_id="$aadhaarIssues[0]->application_id" :scheme_id="$schemeId"
                :doc_type_id_array_list="[107]" :enclosureSource="5" :key="'new-' . $aadhaarIssues[0]->application_id" />

        ...
        <div>
            ...
            <div id="list_menu" x-show="activeMenu === 'SchemeOnboard'" x-collapse x-transition class="pl-4">
                <ul>
                    ...
                    <li>
                        <a href="http://lbv2.test/master-configuration" class="flex item-center px-2 py-1 text-left text-slate-200 rounder hover:bg-slate-700 hover:text-white">
                            ...
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Master Configuration</span></a>
                    </li>
                    <li>

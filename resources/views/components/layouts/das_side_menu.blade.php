@php
    ...
    $menuItems = [
        ...
        [
            ...
            'key' => 'DutyManagement',
            'icon' => $icons['default'],
            'permission' => 'canDutyManagement',
            'children' => [
                [
                    'label' => 'Role Office Type Mapping',
                    'route' => 'role-office-master-mappings',
                    'permission' => 'canRoleMapping',
                ],
                ['label' => 'Office Masters', 'route' => 'officemasters', 'permission' => 'canViewOffices'],
                ['label' => 'Users', 'route' => 'user-managements', 'permission' => 'canViewUser'],
            ],
        ],
        [
            'label' => 'Dynamic Workflow Management',
            'route' => 'dynamic-workflow-config',
            'icon' => $icons['workflow'],
        ...
        [
            ...
            'key' => 'SchemeOnboard',
            'icon' => $icons['default'] . $icons['dashboard_smile'],
            'permission' => 'canSchemeOnboard',
            'children' => [
                ['label' => 'Form Management', 'route' => 'master-tab', 'permission' => 'canMasterTab'],
                ['label' => 'Define Workflow', 'route' => 'define-workflow1', 'permission' => 'canDefineWorkflow'],
                [
                    'label' => 'Scheme Capacity Setting',
                    'route' => 'scheme-capacity',
                    'permission' => 'canSchemeCapacitySetting',
                ],
            ],
        ],
        [
            ...
            'icon' => $icons['default'] . $icons['dashboard_smile'],
            'permission' => 'canUserPermission',
            'children' => [
                [
                    'label' => 'Role Rank Management',
                    'route' => 'role-rank-management',
                    'permission' => 'canRoleRankManagement',
                ],
                ['label' => 'Create Permission', 'route' => 'permission', 'permission' => 'canViewPermission'],
                ['label' => 'Assign Permission', 'route' => 'user-permission', 'permission' => 'canViewUserPermisson'],
                [
                    'label' => 'Role Permission Management',
                    'route' => 'role-permission-management',
                    'permission' => 'canRolePermissionManagement',
                ],
            ],
        ],
        [
            'label' => 'Beneficiary List',
            'route' => 'beneficiaries_selection.index',
            'icon' => $icons['workflow'],
        ...
        [
            'label' => 'Import Janma-Mrityu Data',
            'route' => 'jnmp.pull',
            'icon' => $icons['default'] . $icons['dashboard_smile'],
            'permission' => 'canImportJanmaMrityuData',
        ],
        [
            'label' => 'Re-activate Death Incident',
            'route' => 'jnmp-data',
            'icon' => $icons['default'] . $icons['dashboard_smile'],
            'permission' => 'canReActivateDeathIncident',
        ],
        [
            'label' => 'Janmya-Mrityu Beneficiary List',
            'route' => 'jnmp-marked-data',
            'icon' => $icons['default'] . $icons['dashboard_smile'],
            'permission' => 'canJanmyaMrityuBeneficiaryList',
        ],
        [
            'label' => 'CMO Data Fetch',
            'route' => 'pullnewcmo',
            'icon' => $icons['default'] . $icons['dashboard_smile'],
            'permission' => 'canCMODataFetch',
        ],
        [
            'label' => 'Sarasori Mukhyamantri',
            'key' => 'Sarasori Mukhyamantri',
            'icon' => $icons['default'] . $icons['dashboard_smile'],
            'permission' => 'canSarasoriMukhyamantri',
            'children' => [
                [
                    'label' => 'CMO Grievance Mark',
                    'route' => 'cmo-grievance-workflow',
                    'permission' => 'canCMOGrievanceMark',
                ],
            ],
        ],
        [
        ...
        [
            ...
            'icon' => $icons['default'],
            'permission' => 'canUpdateMarkBeneficiary',
            'children' => [
                [
                    'label' => 'Request Update Beneficiary',
                    'route' => 'request-update-beneficiary',
                    'permission' => 'canRequestUpdateBeneficiary',
                ],
                [
                    'label' => 'Update Mark Beneficiary Details',
                    'route' => 'update-mark-beneficiary-details',
                    'permission' => 'canUpdateMarkBeneficiaryDetails',
                ],
                [
                    'label' => 'Update Beneficiary List',
                    'route' => 'update-beneficiary-list',
                    'permission' => 'canUpdateBeneficiaryList',
                ],
            ],
        ],
    ];

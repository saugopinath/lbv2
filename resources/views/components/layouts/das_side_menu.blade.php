<aside :class="sidebar ? 'w-52' : 'w-16'"
    ...
    <nav class="flex-1 overflow-y-auto mt-2 space-y-1 text-sm">
        ...
        <div x-data="{
            activeMenu: @if (request()->routeIs('lbform') || request()->routeIs('draftlist') || request()->routeIs('lb-application-list')) 'LBFrom'
        @else
            null @endif
        }">
        ...
        @if (\App\Helpers\WorkFlowPermissionHelper::canDutyManagement())
            ...
            <div>
                <button @click="activeMenu === 'DutyManagement' ? activeMenu = null : activeMenu = 'DutyManagement'"
                    ...
                    <span x-show="sidebar" class="mr-2 truncate">Duty Management</span>
                    <svg class="mr-2 w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
        ...
        <div x-data="{
            activeMenu: @if (request()->routeIs('Caste-modification-info') || request()->routeIs('caste-modification-list')) 'CasteManagement'
            @else
                null @endif
        }">
            ...
            @if (\App\Helpers\WorkFlowPermissionHelper::canCaste())
                <div>
                    <button
                        @click="activeMenu === 'CasteManagement' ? activeMenu = null : activeMenu = 'CasteManagement'"
                        class="flex items-center w-full px-4 py-2 text-left hover:bg-slate-700 text-slate-200 hover:text-white rounded">
                        <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path opacity="0.3"
                        ...
                        <svg class="mr-2 w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 10 6">
                    ...
                    <!-- Sub-menu -->
                    <div id="list_menu" x-show="activeMenu === 'CasteManagement'" x-collapse x-transition
                        class="pl-4">
                        <ul>
                            {{-- @can('modify caste') --}}
                            ...
                            <a href="{{ route('cmo-grievance-workflow') }}"
                                ...
                                <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path
                                        d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                        fill="currentColor"></path>
                                </svg><span x-show="sidebar" class="truncate" svg="truncate">CMO Grievance
                                    Mark</span></a>
                        </li>
                    </ul>
                </div>
        ...
        <div>
            <button @click="activeMenu === 'MarkedBeneficiary' ? activeMenu = null : activeMenu = 'MarkedBeneficiary'"
                class="flex items-center w-full px-4 py-2 text-left hover:bg-slate-700 dark:hover:bg-slate-700 text-slate-200 hover:text-white rounded">
                <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path opacity="0.3"
                ...
                <span x-show="sidebar" class="mr-2 truncate">Marked Beneficiary</span>
                <svg class="mr-2 w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="m1 1 4 4 4-4" />
            ...
            <div id="list_menu" x-show="activeMenu === 'MarkedBeneficiary'" x-collapse x-transition class="pl-4">
                <ul>
                    <li>
                        <a href="{{ route('marked-beneficiary') }}"
                            class="flex item-center px-2 py-1 text-left text-slate-200 rounder hover:bg-slate-700 hover:text-white">
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path opacity="0.3"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Mark Beneficiary</span></a>
                    </li>
                    <li>
                        <a href="{{ route('marked-beneficiary-list') }}"
                            class="flex item-center px-2 py-1 text-left text-slate-200 rounder hover:bg-slate-700 hover:text-white">
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path opacity="0.3"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Marked Beneficiary
                                List</span></a>
                    </li>
        ...
        <div>
            <button
                @click="activeMenu === 'FormfieldManagement' ? activeMenu = null : activeMenu = 'FormfieldManagement'"
                class="flex items-center w-full px-4 py-2 text-left hover:bg-slate-700 dark:hover:bg-slate-700 text-slate-200 hover:text-white rounded">
                <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path opacity="0.3"
                ...
                <span x-show="sidebar" class="mr-2 truncate">Other Form Field Management</span>
                <svg class="mr-2 w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="m1 1 4 4 4-4" />
            ...
            <div id="list_menu" x-show="activeMenu === 'FormfieldManagement'" x-collapse x-transition class="pl-4">
                <ul>
                    <li>
                        <a href="{{ route('create-dynamicformfield') }}"
                            ...
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Create Other From
                                Field</span></a>
                    </li>
        ...
        <div>
            <button @click="activeMenu === 'SchemeOnboard' ? activeMenu = null : activeMenu = 'SchemeOnboard'"
                ...
                <span x-show="sidebar" class="mr-2 truncate">Scheme Onboard </span>
                <svg class="mr-2 w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="m1 1 4 4 4-4" />
                        ...
                        <a href="{{ route('master-tab-creation') }}"
                            ...
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Master Tab
                                Creation</span></a>
                    </li>
                        ...
                        <a href="{{ route('master-tab') }}"
                            ...
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Scheme Form Tab
                                Management</span></a>
                    </li>
                    <li>
                    ...
                    <a href="{{ route('create-steps') }}"
                        ...
                        <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <path
                                d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                fill="currentColor"></path>
                        </svg><span x-show="sidebar" class="truncate" svg="truncate">Create Steps</span></a>
                </li>
                <li>
                    <a href="{{ route('assign-workflow') }}"
                        ...
                        <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <path
                                d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                fill="currentColor"></path>
                        </svg><span x-show="sidebar" class="truncate" svg="truncate">Assign Workflow</span></a>
                </li>
            </ul>
        <ul>
            <li>
                <a href="{{ route('duplicate-checks') }}"
                    ...
                    <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path
                            d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                            fill="currentColor"></path>
                    </svg><span x-show="sidebar" class="truncate" svg="truncate">Duplicate Checks</span></a>
            </li>
            <li>
                <a href="{{ route('age-management') }}"
                    ...
                    <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path
                            d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                            fill="currentColor"></path>
                    </svg><span x-show="sidebar" class="truncate" svg="truncate">Age Management</span></a>
            </li>
        </ul>
        <!-- Menu Item: Reports -->
        <!-- <div>

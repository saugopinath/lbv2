                            ...
                            <a href="{{ route('lbform') }}"
                                ...
                                <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="currentColor"></path>
                                </svg><span x-show="sidebar" class="truncate" svg="truncate">Lakshmir Bhandar
                                    Form</span></a>
                        </li>
                        <li>
                            <a href="{{ route('draftlist') }}"
                                ...
                                <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    <path
                                        d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                        fill="currentColor"></path>
                                </svg><span x-show="sidebar" class="truncate" svg="truncate">Draft
                                    Applications</span></a>
                        </li>
                    @endif

                    @if ($user->hasAnyRole(['Verifier', 'Delegated Verifier', 'Approver', 'Delegated Approver']))
                        <li>
                            <a href="{{ route('lb-application-list') }}"
                                ...
                                <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    <path
                                        d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                        fill="currentColor"></path>
                                </svg><span x-show="sidebar" class="truncate" svg="truncate">Workflow</span></a>
                        </li>
                    @endif
                        ...
                        <a href="#"
                            ...
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Submitted
                                Application</span></a>
                    </li> --}}
                </ul>
            </div>
                ...
                <div id="list_menu" x-show="activeMenu === 'Incomplete'" x-collapse x-transition class="pl-4">
                    <ul>
                        ...
                        @if ($user->hasAnyRole(['Verifier', 'Delegated Verifier']))
                            <li>
                                <a href="{{ route('incomplete.types', 'verifier') }}" class="flex item-center px-2 py-1 text-left rounder hover:bg-slate-700 hover:text-white
                        ...
                        @if ($user->hasAnyRole(['Approver', 'Delegated Approver']))
                            <li>
                                <a href="{{ route('incomplete.types', 'approver') }}" class="flex item-center px-2 py-1 text-left rounder hover:bg-slate-700 hover:text-white
                        ...
                        {{-- @if ($user->hasAnyRole(['Verifier', 'Delegated Verifier']))
                        <li>
                            <a href="{{ route('incomplete.types', 'revert') }}" class="flex item-center px-2 py-1 text-left rounder hover:bg-slate-700 hover:text-white
                                {{ $stage === 'revert' ? 'bg-slate-700 text-white' : 'text-slate-200' }}">
                                <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path opacity="0.3"
                                        d="M6.22209 4.60104C6.66665 4.30399 7.13344 4.04635 7.6171 3.82975C8.98898 3.21538 9.67491 2.90819 10.5875 3.4994C11.5 4.0906 11.5 5.0604 11.5 7V8.5C11.5 10.3856 11.5 11.3284 12.0858 11.9142C12.6716 12.5 13.6144 12.5 15.5 12.5H17C18.9396 12.5 19.9094 12.5 20.5006 13.4125C21.0918 14.3251 20.7846 15.011 20.1702 16.3829C19.9536 16.8666 19.696 17.3333 19.399 17.7779C18.3551 19.3402 16.8714 20.5578 15.1355 21.2769C13.3996 21.9959 11.4895 22.184 9.64665 21.8175C7.80383 21.4509 6.11109 20.5461 4.78249 19.2175C3.45389 17.8889 2.5491 16.1962 2.18254 14.3534C1.81598 12.5105 2.00412 10.6004 2.72315 8.8645C3.44218 7.12861 4.65982 5.64491 6.22209 4.60104Z"
                                ...
                                <span x-show="sidebar" class="truncate">Revert Incomplete</span>
                            </a>
                        </li>
                        @endif --}}
                    </ul>
                        ...
                        <a href="{{ route('role-office-master-mappings.index') }}"
                            ...
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Role Office Type
                                Mapping</span></a>
                    </li>
                    <li>
                        <a href="{{ route('officemasters.index') }}"
                            ...
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">OfficeMasters</span></a>
                    </li>
                    <li>
                        <a href="{{ route('user-managements.index') }}"
                            ...
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path
                                    d="M21.446 7.06899C20.6342 5.0083 18.9917 3.36577 16.931 2.55397C15.3895 1.94668 14 3.34315 14 5V9C14 9.55229 14.4477 10 15 10H19C20.6569 10 22.0533 8.61054 21.446 7.06899Z"
                                    fill="currentColor"></path>
                            </svg><span x-show="sidebar" class="truncate" svg="truncate">Users</span></a>
                    </li>
                </ul>
            </div>
        </div>

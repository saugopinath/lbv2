<a href="{{ $href ?? '#' }}" class="relative inline-block w-6 h-6">
    <div x-data="{ show: false }" class="w-full h-full">
        <button
            type="button"
            class="w-full h-full flex items-center justify-center bg-gray-200 rounded-md hover:bg-gray-300 transition cursor-pointer"

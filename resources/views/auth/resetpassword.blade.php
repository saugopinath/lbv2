<x-layouts.guest>
    ...
    <x-errors class="mt-6"  />
    <form class="mt-[60px] space-y-5" action="{{ route('resetPasswordPost') }}" method="POST">
        @csrf
        ...
        <div class="relative">
            <x-text-input id="password" class="form-input h-[66px] bg-transparent dark:bg-transparent text-base rounded-[10px] ps-5 pe-14" type="password" name="user_password" :value="old('user_password')" 
            autofocus autocomplete="off" placeholder="Enter New Password"/>
           
        </div>
     
        <div class="relative">
            <x-text-input id="password" class="form-input h-[66px] bg-transparent dark:bg-transparent text-base rounded-[10px] ps-5 pe-14" type="password" name="confirm_user_password" :value="old('confirm_user_password')" 

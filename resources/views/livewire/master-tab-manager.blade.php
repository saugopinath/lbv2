<div>
    <div class="max-w-5xl mx-auto bg-white border border-gray-200 rounded-xl shadow-sm p-4 space-y-4 mb-4">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-bold text-gray-800">Form Management</h2>
            <a href="{{ route('master-tab-creation') }}">
                <x-button.primary>Add New Master Tab</x-button.primary>
            </a>
        </div>
    </div>

    <div class="max-w-5xl mx-auto bg-white border border-gray-200 rounded-xl shadow-sm p-6 space-y-6">
        <div class="flex items-center gap-2 mb-2 ml-4 border-b border-gray-200">
            <span class="text-md font-semibold text-gray-700 uppercase tracking-wide text-blue-600">Configure the Form Tabs</span>
        </div>
        <div>

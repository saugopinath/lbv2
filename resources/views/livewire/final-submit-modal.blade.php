            ...
            <div class="p-6 space-y-6 text-sm text-gray-700 overflow-y-auto flex-1">
                <div class="flex justify-between items-center border-b pb-4 px-4">
                    ...
                    <div class="flex items-center gap-5">
                        <img src="https://c.animaapp.com/mdn4r47eB5hzlO/img/biswo-2.png" alt="Logo"
                        ...
                        <div>
                            ...
                            <h3 class="text-lg font-semibold text-blue-700 tracking-wide uppercase">
                                {{ $schemeName }} Scheme
                            </h3>
                ...
                @foreach($tabsData as $tab)
                    @if($tab['tab_code'] !== '104')
                        <div
                            class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-2 hover:shadow-md transition-shadow duration-300">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-2 hover:shadow-md transition-shadow duration-300"">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-800">
                                    {{ $documentTab['tab_name'] ?? 'Enclosure Details' }}</h3>
                            </div>
                        </div>

<div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
    <div class="mb-4">
        ...
        <p class="text-sm text-gray-600 mt-1">Search and update beneficiary information</p>
    ...
    <div>
        ...
        <div class="lg:col-span-2 space-y-6">
            @if(!empty($items))
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden animate-fadeIn mt-2" wire:key="search-results-table">

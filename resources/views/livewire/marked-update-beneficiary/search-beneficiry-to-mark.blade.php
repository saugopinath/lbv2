<div class="p-4">
    ...
    <div class="mt-6">
        <div class="overflow-x-auto bg-white shadow-md rounded-lg">
            <h2 class="text-xl font-bold mb-2 pl-2">Searched Beneficiary</h2>
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-150">
                        ...
                        <td class="px-4 py-2 text-center text-sm text-gray-700">{!! $row['address'] !!}</td>
                        ...
                        <td class="px-4 py-2">
                            <form action="{{ route('mark-beneficiary') }}" method="GET" class="flex justify-center">
                                ...
                                <x-button.loading-spiner-button type="submit" text="Mark" lockPage="true" />
                            </form>
                        </td>
                    </tr>
                    @endforeach

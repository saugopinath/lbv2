    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                <thead style="background-color: #065f46 !important; color: #ffffff !important;" class="text-xs uppercase tracking-wider">
                    <tr style="background-color: #065f46 !important; color: #ffffff !important;">
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-left whitespace-nowrap">Temp. Application ID</th>
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-left whitespace-nowrap">Family Members Name</th>
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-left whitespace-nowrap">Mobile No</th>
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-left whitespace-nowrap">Aadhaar No</th>
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-center whitespace-nowrap">Age</th>
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-center whitespace-nowrap">Gender</th>
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-left whitespace-nowrap">Address</th>
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-center whitespace-nowrap">Status</th>
                        <th style="background-color: #065f46 !important; color: #ffffff !important; color: white !important;" class="px-4 py-3 text-center whitespace-nowrap">Action</th>
                    </tr>
                </thead>

<div class="w-full space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-4 space-y-4">
        <livewire:dynamic-workflow.caste-workflow-table :scheme-id="$schemeId" :moduleCode="$moduleCode" :wire:key="'caste-workflow-table-'.$schemeId.'-'.$moduleCode" />
    </div>
    <!-- Modal Container -->
    <livewire:dynamic-workflow.caste-workflow-modal />
    @endif

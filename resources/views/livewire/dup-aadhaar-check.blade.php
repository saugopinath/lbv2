<div x-data="{
    ...
    <div class="grid gap-6 md:grid-cols-3 mb-6 p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <!-- Aadhaar Input -->
        <div>
            <x-form.input id="check_aadhar" name="aadhar_number" label="Aadhaar Number"
                placeholder="Enter Aadhaar Number" required x-model="aadhaar" x-on:input="aadhaar = $el.value.replace(/[^0-9]/g, '').slice(0,12);
        $el.value = aadhaar;" />
        </div>

...
<div>
    ...
    {{--  @if (isset($showErrors) && $showErrors && $missingRequired->isNotEmpty())
        <div class="mt-4 px-6">
            <ul class="list-disc text-red-600 ml-6">
                @foreach ($missingRequired as $doc)
                    <li>{{ $doc->codemaster->name }} document is required.</li>
                @endforeach
            </ul>
        </div>
    @endif  --}}

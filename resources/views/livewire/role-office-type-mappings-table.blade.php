<div class="bg-white dark:bg-gray-800 shadow-md rounded p-4 space-y-4" x-data="{ confirmDelete(id) {
    if (confirm('Do you want to delete this role Office mapping?')) {
        $wire.deleteUser(id)
    }
}}">
    ...
    <div class="overflow-x-auto border rounded-lg shadow-sm">
        <table class="min-w-full text-sm text-gray-700 text-center">
            ...
            <tbody class="divide-y divide-gray-200 bg-white overflow-y-auto">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="py-3 text-gray-500">No records found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    @endif
        ...
        <div class="flex items-center mt-6 gap-3">
            <!-- Search Button -->
            <x-button.search wire:click="search">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" viewBox="0 0 640 640"
                    fill="currentColor">
                    <path
            ...
            <!-- Reset Button -->
            <x-button.reset wire:click="resetFilters">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" viewBox="0 0 640 640"
                    fill="currentColor">
                    <path

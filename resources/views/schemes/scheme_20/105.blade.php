<div class='space-y-2'><div class="pl-0">
    <x-form.input
        type="text"
        name="das"
        label="fsgd"
    ...
    <x-form.checkbox
        ...
        label="zsfdhgzd"
        value="1"
        wire:model.live="formData.gvsz"
    />
</div><div class="pl-6">
    <x-form.select
        name="fffs"
        label="sdgfvs"
        wire:model.live="formData.fffs"
    >
        <option value="">-- Select sdgfvs --</option>
        <option value="fdgvbfd">fdgvbfd</option>
<option value="dfgbd">dfgbd</option>

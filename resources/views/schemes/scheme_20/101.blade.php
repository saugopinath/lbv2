...
<div class="grid md:grid-cols-3 gap-4 mt-4">
    <x-form.input type="date" name="ds_date" label="Duare Sarkar Date" wire:model="formData.ds_date" /><x-form.input
        type="text" name="age" label="Age" wire:model="formData.age" /><x-form.input type="date" name="dob"
        label="Date of Birth" wire:model="formData.dob" />
</div>
<div class="grid md:grid-cols-1 gap-4 mt-4">
...
<div class="grid md:grid-cols-3 gap-4 mt-4">
    ...
    </x-form.select><x-form.input type="text" name="reg_no" label="Duare Sarkar Registration Number"
        wire:model="formData.reg_no" /><x-form.input type="text" name="full_name" label="Applicant Name"

<div class="grid md:grid-cols-3 gap-4 mt-4">
    <x-form.select name="app_type" label="Application Type" wire:model="formData.app_type">
        ...
        wire:model="formData.app_date" /><x-form.input type="date" name="ds_date" label="Duare Sarkar Date"
...
<div class="grid md:grid-cols-3 gap-4 mt-4">
    <x-form.input type="date" name="dob" label="Date of Birth" wire:model="formData.dob" /><x-form.input type="text"
        name="mfname" label="Mother's Name" wire:model="formData.mfname" /><x-form.input type="text" name="reg_no"
        label="Duare Sarkar Registration Number" wire:model="formData.reg_no" />
</div>
<div class="grid md:grid-cols-2 gap-4 mt-4">
    <x-form.input type="text" name="full_name" label="Applicant Name" wire:model="formData.full_name" /><x-form.input
        type="text" name="email_id" label="Email Address" wire:model="formData.email_id" />
</div>
<div class="grid md:grid-cols-3 gap-4 mt-4">

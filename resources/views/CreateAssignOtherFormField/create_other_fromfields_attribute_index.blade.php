<x-layouts.app>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-2 space-y-4">
        <div class="flex justify-between items-center text-center">
            ...
            <x-form.back-button :url="route('tab-field-manager', ['scheme_id' => request()->query('scheme_id')])" />

            <button class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 cursor-pointer" x-data

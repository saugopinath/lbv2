    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-[auto_650px_auto] gap-8" style="
            ...
            <div style="grid-area: map;">
                <div class="bg-white rounded-3xl shadow-sm p-4 h-[650px] relative flex flex-col">
            ...
            <div style="grid-area: info;">
                <div class="bg-white rounded-3xl shadow-sm h-[650px] flex flex-col overflow-hidden">

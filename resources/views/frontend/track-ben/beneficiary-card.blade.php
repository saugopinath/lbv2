    ...
    <div class="relative flex justify-between items-center mb-8">
        ...
        <div class="flex flex-col items-end">
            <div
                ...
                <span class="text-[9px] text-white/50 uppercase font-bold tracking-widest">Application ID:</span>
                <span
                    class="text-indigo-300 font-mono font-bold text-xs tracking-wider drop-shadow-sm">{{ $applicationId }}</span>
            </div>
        </div>
        @if ($beneficiaryId)
            <div class="flex flex-col items-end">
                <div
                    class="flex items-center gap-2 bg-white/10 border border-white/20 px-3 py-1.5 rounded-xl backdrop-blur-md shadow-sm group/id">
                    <span class="text-[9px] text-white/50 uppercase font-bold tracking-widest">Beneficiary ID:</span>
                    <span
    ...
    <div class="relative space-y-4 mb-8">
        <div
            ...
            <div class="overflow-hidden">
                <p class="text-[9px] text-white/40 uppercase font-black tracking-[0.12em] mb-0.5">Applied Scheme</p>
                <p

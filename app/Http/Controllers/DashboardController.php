...
class DashboardController extends Controller
{
    ...
    //     // $lgd_session['role_id'] = Crypt::encryptString(1);
    //   }
    //   Session::put('lgd_session', $lgd_session);
    //   $roleID = $roleSchemeOfficeMappings->role_id;
    //   if ($roleID == 1) {
    //     $dashBoardVisible = 1;
    //   } else {
    //     $dashBoardVisible = 0;
    ...
    //                 $lgd_session['scheme_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->scheme_id
    //                     );
    //             }
    ...
    //                 $lgd_session['role_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->role_id
    //                     );
    //             }

    //             if (! is_null($roleSchemeOfficeMappings->Office->office_type_id)) {

    //                 $lgd_session['office_type_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->Office->office_type_id
    //                     );
    //             }

    //             if (! is_null($roleSchemeOfficeMappings->Office->state_id)) {

    //                 $lgd_session['state_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->Office->state_id
    //                     );
    //             }

    //             if (! is_null($roleSchemeOfficeMappings->Office->district_id)) {

    //                 $lgd_session['district_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->Office->district_id
    //                     );
    //             }

    //             if (! is_null($roleSchemeOfficeMappings->Office->block_id)) {

    //                 $lgd_session['block_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->Office->block_id
    //                     );
    //             }

    //             if (! is_null($roleSchemeOfficeMappings->Office->subdivision_id)) {

    //                 $lgd_session['subdivision_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->Office->subdivision_id
    //                     );
    //             }

    //             if (! is_null($roleSchemeOfficeMappings->Office->panchayat_id)) {

    //                 $lgd_session['panchayat_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->Office->panchayat_id
    //                     );
    //             }

    //             if (! is_null($roleSchemeOfficeMappings->Office->municipalitiy_id)) {

    //                 $lgd_session['municipalitiy_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->Office->municipalitiy_id
    //                     );
    //             }
    ...
    //                 $lgd_session['ward_id'] =
    //                     Crypt::encryptString(
    //                         $roleSchemeOfficeMappings->Office->ward_id
    //                     );
    //             }
    ...
    //             $dashBoardVisible = 0;
    //         }
    // // dd($scheme_ids,$lgd_session);
    //         return view(
    //             'admin.index',
    //             compact('dashBoardVisible')
    //         );
    //     }
    public function index()
    {
        ...
        if (! is_null($roleSchemeOfficeMappings)) {
            ...
            if (! is_null($roleSchemeOfficeMappings->Office)) {
                ...
                $office =
                    $roleSchemeOfficeMappings->Office;
        ...
        $roleID =
            $roleSchemeOfficeMappings->role_id ?? 0;

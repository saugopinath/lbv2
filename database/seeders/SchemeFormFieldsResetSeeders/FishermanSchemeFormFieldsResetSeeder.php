...
class FishermanSchemeFormFieldsResetSeeder extends Seeder
{
    public function run(): void
    {
        $scheme = Scheme::where('short_name', 'fisherman_oap')
            ->orWhere('name', 'LIKE', '%FISHERMAN%')
            ->first() ?? Scheme::find(5);

        if (!$scheme) {
            $this->command?->error('Fisherman Scheme not found!');
            return;
        }
        ...
        DB::transaction(function () use ($schemeId) {
            ...
            $customBaseFields = [
                ...
                [
                    'tab_code' => 101,
                    'field_id' => 'belongs_to_fisherman_community',
                    'field_name' => 'belongs_to_fisherman_community',
                    'level_name' => 'Belongs to Fisherman Community',
                    'field_type' => 'select',
                    'options' => ['1' => 'Yes', '2' => 'No'],
                    'validation_rule' => 'required',
                    'db_colunm' => 'other_details',
                ...
                [
                    'tab_code' => 101,
                    'field_id' => 'physically_handicapped',
                    'field_name' => 'physically_handicapped',
                    'level_name' => 'Physically Handicapped',
                    'field_type' => 'select',
                    'options' => ['1' => 'Yes', '2' => 'No'],
                    'validation_rule' => 'required',
                    'db_colunm' => 'other_details',
            ...
            $fieldsByTab = [
                101 => [
                    ...
                    'belongs_to_fisherman_community',
            ...
            $docs = [
                ['code' => '161', 'is_required' => true, 'max_file_size' => '100KB', 'extension_type' => 'jpg,png,jpeg,pdf'], // Passport
                ['code' => '165', 'is_required' => true, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Aadhaar
                ['code' => '169', 'is_required' => true, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Bank Pass Book
                ['code' => '162', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Caste Certificate
                ['code' => '168', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Income Certificate
                ['code' => '167', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Residential Certificate
                ['code' => '164', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Ration Card
                ['code' => '166', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // EPIC / Voter Id
            ];
        ...
        $this->command?->info("Fisherman Pension (Scheme ID {$schemeId}) form fields successfully reset and regenerated!");
    }
}

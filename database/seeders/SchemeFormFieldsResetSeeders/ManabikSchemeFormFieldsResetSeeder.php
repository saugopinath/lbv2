...
class ManabikSchemeFormFieldsResetSeeder extends Seeder
{
    public function run(): void
    {
        $scheme = Scheme::where('short_name', 'manabik')
            ->orWhere('name', 'LIKE', '%MANABIK%')
            ->first() ?? Scheme::find(2);

        if (!$scheme) {
            $this->command?->error('Manabik Scheme not found!');
            return;
        }
        ...
        DB::transaction(function () use ($schemeId) {
            ...
            $customBaseFields = [
                ...
                [
                    'tab_code' => 101,
                    'field_id' => 'type_of_disability',
                    'field_name' => 'type_of_disability',
                    'level_name' => 'Type of Disability',
                    'field_type' => 'select',
                    'options' => ['1' => 'Locomotor', '2' => 'Visual', '3' => 'Hearing', '4' => 'Mental', '5' => 'Multiple'],
                    'validation_rule' => 'required',
                    'db_colunm' => 'other_details',
                    'is_common' => false,
                    'is_active' => true,
                ...
                [
                    'tab_code' => 101,
                    'field_id' => 'percentage_of_disability',
                    'field_name' => 'percentage_of_disability',
                    'level_name' => 'Percentage of Disability',
                    'field_type' => 'text',
                    'validation_rule' => 'required|numeric|between:40,100',
                    'regex' => '^[0-9]+$',
                    'db_colunm' => 'other_details',
                    'is_common' => false,
                    'is_active' => true,
                ...
                [
                    'tab_code' => 101,
                    'field_id' => 'authority_name',
                    'field_name' => 'authority_name',
                    'level_name' => 'Authority Name',
                    'field_type' => 'text',
                ...
                [
                    'tab_code' => 101,
                    'field_id' => 'authority_designation',
                    'field_name' => 'authority_designation',
                    'level_name' => 'Authority Designation',
                    'field_type' => 'text',
                    'validation_rule' => 'required|string',
                    'db_colunm' => 'other_details',
                    'is_common' => false,
            ...
            // 5. Seed Form Fields for Tabs (Note: Manabik 106 does NOT include voter_id_number)
            $fieldsByTab = [
                101 => [
                    'application_date',
                    'application_type',

...
class OldAgePensionSchemeFormFieldsResetSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::transaction(function () use ($schemeId) {
            ...
            // 6. Seed Attached Documents (Tab 104: Photo 103, Aadhaar 107, Bank Passbook 111, Ration Card 106, Aadhaar Consent 126, Age Proof Documents 129)
            $docs = [
                ...
                ['doc_type_id' => 129, 'is_required' => true, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'],
            ];

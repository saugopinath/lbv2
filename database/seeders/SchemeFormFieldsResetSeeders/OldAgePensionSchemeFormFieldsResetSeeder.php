...
class OldAgePensionSchemeFormFieldsResetSeeder extends Seeder
{
    public function run(): void
    {
        $scheme = Scheme::where('short_name', 'oap_wcd')
            ->orWhere('name', 'LIKE', '%OLD AGE%')
            ->first() ?? Scheme::find(10);

        if (!$scheme) {
            $this->command?->error('WCD Old Age Pension Scheme not found!');
            return;
        }
        ...
        DB::transaction(function () use ($schemeId) {
            ...
            // Ensure Codemaster entry for Certificate from College exists
            \App\Models\Codemaster::firstOrCreate(
                ['code' => '1633'],
                [
                    'name' => 'CERTIFICATE FROM COLLEGE',
                    'short_name' => 'certificate_from_college_enc',
                    'parent_short_code' => 'ENCDETAILS',
                    'parent_id' => \App\Models\Codemaster::where('code', '16')->first()?->id,
                    'is_active' => true,
                ]
            );
            ...
            $docs = [
                ...
                ['code' => '1623', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Certificate from a Government Medical Officer
                ...
                ['code' => '1614', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Birth registration Certificate
                ...
                ['code' => '1618', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Certificate from school
                ['code' => '1633', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Certificate from college
                ['code' => '1619', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Certificate from Secondary Education Board
                ['code' => '1620', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Certificate from recognized educational institution
                ['code' => '1621', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Certificate from the Sabhapati of a Panchayatsamity
                ['code' => '1622', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // Certificate from the chairman of a municipal corporation
            ];

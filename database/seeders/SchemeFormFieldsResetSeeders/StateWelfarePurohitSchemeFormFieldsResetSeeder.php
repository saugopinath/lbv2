    ...
    public function run(): void
    {
        ...
        DB::transaction(function () use ($schemeId) {
            ...
            $customBaseFields = [
                ...
                [
                    'tab_code' => 107,
                    'field_id' => 'in_the_name_of',
                    'field_name' => 'in_the_name_of',
            ...
            $selfDecls = [
                ...
                [
                    ...
                    'level_name' => 'a beneficiary of any other Social Security pension scheme or a recipient of Government pension or pension from any other organization.',
                    'field_type' => 'select',
                    'options' => ['am' => 'am', 'am not' => 'am not'],
                    'validation_rule' => 'required',
                    'section_level_id' => $sectionIds['ben_sec'] ?? null,
                    'section_level_type' => 0,
                    'field_position' => 2,
                ],
                [
                    ...
                    'level_name' => 'have Pucca dwelling house.',
                    'field_type' => 'select',
                    'options' => ['do' => 'do', 'do not' => 'do not'],
                    'validation_rule' => 'required',
                    'section_level_id' => $sectionIds['pucca'] ?? null,
                    'section_level_type' => 0,
                    'field_position' => 3,
                ],
                [

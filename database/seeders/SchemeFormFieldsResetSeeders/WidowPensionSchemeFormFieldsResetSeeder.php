...
class WidowPensionSchemeFormFieldsResetSeeder extends Seeder
{
    public function run(): void
    {
        $scheme = Scheme::where('short_name', 'wp_wcd')
            ->orWhere('name', 'LIKE', '%WIDOW%')
            ->first() ?? Scheme::find(11);

        if (!$scheme) {
            $this->command?->error('WCD Widow Pension Scheme not found!');
            return;
        }
        ...
        DB::transaction(function () use ($schemeId) {
            ...
            $customBaseFields = [
                ...
                [
                    'tab_code' => 101,
                    'field_id' => 'husband_name',
                    'field_name' => 'husband_name',
                    'level_name' => "Husband's Name",
                    'field_type' => 'text',
            ...
            $docs = [
                ...
                ['code' => '166', 'is_required' => false, 'max_file_size' => '500KB', 'extension_type' => 'jpg,jpeg,png,pdf'], // EPIC
            ];
            ...
            $selfDecls = [
                ...
                [
                    ...
                    'field_id' => 'not_remarried_declaration',
                    'level_name' => 'I hereby declare that I have not remarried',
                    'field_type' => 'checkbox',
                    'validation_rule' => 'required',
        ...
        $this->command?->info("WCD Widow Pension Scheme (Scheme ID {$schemeId}) form fields successfully reset and regenerated!");
    }
}
